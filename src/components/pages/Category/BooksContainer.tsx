...
export const BooksContainer = () => {
    const {books, error} = useFetchBooks("https://freetestapi.com/api/v1/books");
    if (error) {
           ...
           <div className="mb-10">
               <div className="items-center justify-between gap-3 flex flex-wrap">
                   ...
                   <div className="text-xl">
                       <Link className="flex font-normal items-center text-black hover:text-orange-600">Xem tất cả <FiArrowRight className=" text-black items-center ml-1 hover:text-orange-600" /></Link>
                   </div>
               </div>
           </div>
